...
variable "mgmt_sg_rules" {
  description = "Security rules for the Management Network Security Group"
  type = list(object({
    name                       = string
    priority                   = number
    direction                  = string
...
variable "wan_sg_rules" {
  description = "Security rules for the WAN Network Security Group"
  type = list(object({
    name                       = string
    priority                   = number
    direction                  = string
...
variable "lan_sg_rules" {
  description = "Security rules for the LAN Network Security Group"
  type = list(object({
    name                       = string
    priority                   = number
    direction                  = string
  ...
  default = [
    ...
    {
      name                       = "Allow-RFC1918-172-Inbound"
      priority                   = 110
      direction                  = "Inbound"
      access                     = "Allow"
      protocol                   = "*"
    ...
    {
      name                       = "Allow-RFC1918-192-Inbound"
      priority                   = 120
      direction                  = "Inbound"
      access                     = "Allow"
      protocol                   = "*"
